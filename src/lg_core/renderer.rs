...
unsafe fn pick_physical_device(instance: &Instance, data: &mut RendererData) -> Result<(), MyError> {
...
unsafe fn get_depth_format(instance: &Instance, data: &RendererData) -> Result<vk::Format, MyError>
{
    let canditates = &[
...
unsafe fn create_command_buffers(device: &Device, data: &mut RendererData) -> Result<(), MyError>
{
...
unsafe fn create_sync_objects(device: &Device, data: &mut RendererData) -> Result<(), MyError>
{
...
fn load_model(data: &mut RendererData) -> Result<(), MyError> {
