...
unsafe fn pick_physical_device(instance: &Instance, data: &mut RCoreData) -> Result<(), MyError> {
...
unsafe fn get_depth_format(instance: &Instance, data: &RCoreData) -> Result<vk::Format, MyError>
{
    let canditates = &[
...
unsafe fn create_command_buffers(device: &Device, data: &mut RCoreData) -> Result<(), MyError>
{
...
unsafe fn create_sync_objects(device: &Device, data: &mut RCoreData) -> Result<(), MyError>
{
...
fn load_model(data: &mut RCoreData) -> Result<(), MyError> {
